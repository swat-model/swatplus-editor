...
<template>
	<div>
		...
		<p>
			If you do not know the cause of the error, please copy and paste the log below into the
			<open-in-browser url="https://groups.google.com/d/forum/swatplus-editor" text="SWAT+ Editor user group" />. Please include your project
			database and any other relevant files.
		</p>

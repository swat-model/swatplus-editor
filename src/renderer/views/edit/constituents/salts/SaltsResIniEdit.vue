...
<template>
	<project-container :loading="data.page.loading" :load-error="data.page.error">
		...
		<edit-form is-update allow-bulk-edit
				   :item="data.item"
				   name="Reservoir Initial Conditions" :table="data.paths.vars" no-gis
				   :vars="data.vars"
				   :api-url="data.paths.data"
				   redirect-route="ConstituentsSaltsResIni">
			<template #actions>
				<v-btn to="/edit/cons/reservoirs/initial" type="button" variant="flat" color="info" class="mr-2">Assign to Reservoirs/Wetlands</v-btn>
			</template>
		</edit-form>
	</project-container>
</template>

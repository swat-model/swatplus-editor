...
<template>
	...
	>
		...
		>
			...
			>
			/
			<router-link to="/edit/constituents/salts/res"
				>Reservoir Initial Conditions</router-link
			>
			/ Edit
		</file-header>
		...
		<edit-form
			...
			allow-bulk-edit
			:item="data.item"
			name="Reservoir Initial Conditions"
			:table="data.paths.vars"
			no-gis
			:vars="data.vars"
			:api-url="data.paths.data"
			redirect-route="ConstituentsSaltsResIni"
		>
			<template #actions>
				<v-btn
					to="/edit/cons/reservoirs/initial"
					type="button"
					variant="flat"
					color="info"
					class="mr-2"
					>Assign to Reservoirs/Wetlands</v-btn
				>
			</template>
		</edit-form>
	</project-container>

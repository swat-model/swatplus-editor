...
async function saveValues() {
	...
	if (!valid) {
		...
		if (data.page.values.form.update) {
			action = api.put(
				`salts/road-values/${data.page.values.form.id}`,
				data.page.values.obj,
				currentProject.getApiHeader(),
			);
		} else {
			action = api.post(
				`salts/road/${route.params.id}`,
				data.page.values.obj,
				currentProject.getApiHeader(),
			);
		}
...
async function confirmDelete() {
	...
	try {
		await api.delete(
			`salts/road-values/${data.page.values.delete.id}`,
			currentProject.getApiHeader(),
		);
		await getValues();
	...
	>
		<div v-if="route.name == 'ConstituentsSaltsRoadEdit'">
			...
			>
				...
				>
				/
				<router-link to="/edit/constituents/salts/road"
					>Road Salt</router-link
				>
				/ Edit
			</file-header>
						...
						<v-row>
							<v-col cols="12">
								<div class="form-group mb-0">
									<v-text-field
										v-model="data.page.values.obj.so4"
										label="Sulfate (so4)"
										type="number"
										step="any"
										suffix="g/m3"
								...
								<div class="form-group mb-0">
									<v-text-field
										v-model="data.page.values.obj.ca"
										label="Calcium (ca)"
										type="number"
										step="any"
										suffix="g/m3"
								...
								<div class="form-group mb-0">
									<v-text-field
										v-model="data.page.values.obj.mg"
										label="Magnesium (mg)"
										type="number"
										step="any"
										suffix="g/m3"
								...
								<div class="form-group mb-0">
									<v-text-field
										v-model="data.page.values.obj.na"
										label="Sodium (na)"
										type="number"
										step="any"
										suffix="g/m3"
								...
								<div class="form-group mb-0">
									<v-text-field
										v-model="data.page.values.obj.k"
										label="Potassium (k)"
										type="number"
										step="any"
										suffix="g/m3"
								...
								<div class="form-group mb-0">
									<v-text-field
										v-model="data.page.values.obj.cl"
										label="Chlorine (cl)"
										type="number"
										step="any"
										suffix="g/m3"
								...
								<div class="form-group mb-0">
									<v-text-field
										v-model="data.page.values.obj.co3"
										label="Carbonate (co3)"
										type="number"
										step="any"
										suffix="g/m3"
								...
								<div class="form-group mb-0">
									<v-text-field
										v-model="data.page.values.obj.hco3"
										label="Hydrogen carbonate (hco3)"
										type="number"
										step="any"
										suffix="g/m3"
										:error-messages="

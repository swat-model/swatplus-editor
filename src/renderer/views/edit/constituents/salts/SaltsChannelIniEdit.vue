...
<template>
	<project-container :loading="data.page.loading" :load-error="data.page.error">
		<file-header input-file="constituents.cs" docs-path="constituents" use-io>
			...
			/ <router-link to="/edit/constituents/salts/cha">Channel Initial Conditions</router-link>
			/ Edit
		</file-header>

		<edit-form is-update allow-bulk-edit
				   :item="data.item"
				   name="Channel Initial Conditions" :table="data.paths.vars" no-gis
				   :vars="data.vars"
				   :api-url="data.paths.data"
				   redirect-route="ConstituentsSaltsChannelIni">
			<template #actions>
				<v-btn to="/edit/cons/channels/initial" type="button" variant="flat" color="info" class="mr-2">Assign to Channels</v-btn>
			</template>
		</edit-form>
	</project-container>
</template>

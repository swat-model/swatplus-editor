...
<template>
	...
	>
		...
		>
			...
			>
			/
			<router-link to="/edit/constituents/salts/aqu"
				>Aquifer Initial Conditions</router-link
			>
			/ Edit
		</file-header>
		...
		<edit-form
			...
			allow-bulk-edit
			:item="data.item"
			name="Aquifer Initial Conditions"
		...
		>
			<template #actions>
				<v-btn
					to="/edit/cons/aquifers/initial"
					type="button"
					variant="flat"
					color="info"
					class="mr-2"
					>Assign to Aquifers</v-btn
				>
			</template>
		</edit-form>
	</project-container>

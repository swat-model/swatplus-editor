...
<template>
	<project-container :loading="data.page.loading" :load-error="data.page.error">
		<file-header input-file="chem_app.ops" docs-path="management-practices/chem_app.ops" use-io>
			<router-link to="/edit/lum/ops">Operations</router-link> 
			<router-link to="/edit/lum/ops/chemapp">/Chemical Applications</router-link> 
			/ Edit
		</file-header>

		<edit-form show-description show-range is-update get-datasets-record allow-bulk-edit
			:item="data.item"
			name="Operations" table="chem_app_ops" no-gis
			:vars="data.vars" 
			api-url="ops/chemapp"
			redirect-route="OperationsChemApp" />
	</project-container>
</template>

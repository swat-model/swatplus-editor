	...
	<div>
		...
		<v-form @submit.prevent="save">
			<div v-if="page.bulk.show">
				<object-selector name="Aquifers" table="aqu_con" @change="bulkSelectionChange"></object-selector>
			</div>
			
			<connect-form
				:item="item.connect" :item-outflow="item.outflow" :api-url="props.apiUrl" outflow-con-id-field="aquifer_con_id"

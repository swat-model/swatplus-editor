...
<template>
	<project-container :loading="data.page.loading" :load-error="data.page.error">
		<file-header input-file="sediment.res" docs-path="connections/reservoirs">
			<router-link to="/edit/cons/reservoirs">Reservoirs</router-link> / 
			<router-link to="/edit/cons/reservoirs/sediment">Sediment</router-link>
			/ Edit
		</file-header>

		<edit-form show-range is-update allow-bulk-edit
			name="Reservoirs" table="sed_res"
			:item="data.item" 
			:vars="data.vars" 
			api-url="reservoirs/sediment"
			redirect-route="ReservoirsSediment" />
	</project-container>
</template>
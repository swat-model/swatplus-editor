<script setup lang="ts">
	...
	let table:any = {
		...
		headers: [
			...
			{ key: 'soil_plant_init', label: 'Soil Plant', type: 'object', class: 'text-right', objectRoutePath: '/edit/init/soil_plant/edit/' },
			{ key: 'surf_stor', label: 'Surface Storage', type: 'object', class: 'text-right', objectRoutePath: '/edit/reservoirs/wetlands/edit/' },				

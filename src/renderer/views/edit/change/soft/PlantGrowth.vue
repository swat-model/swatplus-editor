	...
	<project-container :loading="data.page.loading">
		...
		<v-form @submit.prevent="save">
			...
			<div class="form-group mb-0">
				<v-checkbox
					label="Enable plant growth soft calibration"
			...
			<div v-if="data.enabled">
				...
				<p class="mb-4">
					Select plants to calibrate, and enter the yield and
					parameter limits below. Selected plants should be modeled in
					your
					<router-link to="/edit/lum/landuse" class="text-primary"
						>land use management</router-link
					>. When you run the model, it will generate new a
					...
					hydrology.hyd, turn off plant growth soft calibration, and
				...
				<v-alert
					type="info"
					variant="tonal"
					v-if="!data.plants || data.plants.length < 1"
					class="my-3"
				>
					...
					<v-form ref="plantForm">
						<div class="form-group">
							<auto-complete
								label="Select a crop"
								required
								v-model="data.plant.item.name"
								:value="data.plant.item.name"
								table-name="plant"
						...
						<div class="form-group">
							<v-text-field
								label="Crop yield - average annual t/ha dry weight"
								v-model.number="data.plant.item.yld"
								type="number"
								step="any"
								required
							></v-text-field>
						...
						>
							...
							<tbody>
								<tr
									v-for="(item, index) in data.plant.item
										.params"
									:key="index"
								>
									<td>
